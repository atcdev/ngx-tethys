...
var ThyClickDispatcher = /** @class */ (function (_super) {
    ...
    ThyClickDispatcher.ngInjectableDef = i0.defineInjectable({ factory: function ThyClickDispatcher_Factory() { return new ThyClickDispatcher(i0.inject(i1.DOCUMENT), i0.inject(i0.NgZone)); }, token: ThyClickDispatcher, providedIn: "root" });
    ThyClickDispatcher = __decorate([
        Injectable({
            providedIn: 'root'
        }),
